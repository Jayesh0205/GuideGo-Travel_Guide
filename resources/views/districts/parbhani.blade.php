...
<head>
  ...
  <title>Parbhani — Golden City of Maharashtra</title>
...
{{-- ══════════ NAVBAR ══════════ --}}
<nav class="jg-nav">
  <a href="#" class="jg-brand">Parbhani<em>.</em></a>
...
{{-- ══════════ HERO ══════════ --}}
<div class="jg-hero">
  {{-- Replace with your actual asset path, e.g. asset('images/parbhani-hero.jpg') --}}
  <img src="{{ asset('img/parbhani.png') }}"
       alt="Parbhani aerial night view"
       class="jg-hero__img"
  ...
  <div class="jg-hero__content">
    ...
    <h1 class="jg-hero__title">Parbhani</h1>
    <p class="jg-hero__sub">The Cultural Heart of Marathwada</p>
  </div>
</div>
...
<main class="jg-page">
  ...
  <section class="jg-block" id="about">
    ...
    <div class="jg-city-card">
      <img src="{{ asset('images/parbhani.png') }}"
           alt="Parbhani"
           class="jg-city-card__img"
           onerror="this.outerHTML='<div class=\'jg-city-card__img-ph\'>🏙️</div>'"/>
      <div class="jg-city-card__body">
        <div class="jg-city-card__name">Parbhani</div>
        <div class="jg-city-card__desc">Religious landmarks, cultural heritage, fertile farmlands and traditional Marathwada charm.</div>
      </div>
    ...
    <div class="jg-content">
      <h2 class="jg-heading">About Parbhani</h2>

      <div class="jg-about-box">
        Parbhani is a city of golden heritage nestled in the heart of Maharashtra. Known as the
        <strong>Banana Capital of India</strong>, it enchants visitors with the magnificent
        Hazrat Turabul Haq Dargah — a UNESCO World Heritage Site — along with lush banana plantations,
        ...
        <div class="jg-scroll-wrap mt-2">
          <div class="jg-hstrip" id="strip-attract">
            ...
            <div class="jg-attract">
              <img src="{{ asset('images/ajanta.png') }}" alt="Hazrat Turabul Haq Dargah" class="jg-attract__img"
              ...
              <div class="jg-attract__body">
                ...
                <div class="jg-attract__name">Hazrat Turabul Haq Dargah</div>
              </div>
            </div>

            <div class="jg-attract">
              <img src="{{ asset('images/giran.png') }}" alt="Shri Sai Janasthan Temple" class="jg-attract__img"
                   onerror="this.outerHTML='<div class=\'jg-attract__img-ph\'>🌊</div>'"/>
              <div class="jg-attract__body">
                <span class="jg-attract__tag">Nature</span>
                <div class="jg-attract__name">Shri Sai Janasthan Temple</div>
              </div>
            </div>

            <div class="jg-attract">
              <img src="{{ asset('images/muktai.png') }}" alt="Jintur Jain Temples" class="jg-attract__img"
                   onerror="this.outerHTML='<div class=\'jg-attract__img-ph\'>🛕</div>'"/>
              <div class="jg-attract__body">
                <span class="jg-attract__tag">Spiritual</span>
                <div class="jg-attract__name">Jintur Jain Temples</div>
              </div>
            </div>

            <div class="jg-attract">
              <img src="{{ asset('images/mehrun.png') }}" alt="Nrusimha Temple" class="jg-attract__img"
                   onerror="this.outerHTML='<div class=\'jg-attract__img-ph\'>🏞️</div>'"/>
              <div class="jg-attract__body">
                <span class="jg-attract__tag">Scenic</span>
                <div class="jg-attract__name">Nrusimha Temple</div>
              </div>
            </div>

            <div class="jg-attract">
              <img src="{{ asset('images/manudevi.png') }}" alt="Mudgal Fort" class="jg-attract__img"
                   onerror="this.outerHTML='<div class=\'jg-attract__img-ph\'>🍌</div>'"/>
              <div class="jg-attract__body">
                <span class="jg-attract__tag">Devotional</span>
                <div class="jg-attract__name">Mudgal Fort</div>
              </div>
            </div>
    ...
    <div class="jg-content">
      ...
      <div class="jg-scroll-wrap">
        <div class="jg-hotel-grid">
          ...
          <div class="jg-hotel">
            <img src="{{ asset('images/plaza.png') }}" alt="Hotel City Palace" class="jg-hotel__img"
                 onerror="this.outerHTML='<div class=\'jg-hotel__img-ph\'>🏨</div>'"/>
            <div class="jg-hotel__body">
              <div class="jg-hotel__name">Hotel City Palace</div>
          ...
          <div class="jg-hotel">
            <img src="{{ asset('images/banana.png') }}" alt="Hotel Aishwarya" class="jg-hotel__img"
                 onerror="this.outerHTML='<div class=\'jg-hotel__img-ph\'>🏨</div>'"/>
            <div class="jg-hotel__body">
              <div class="jg-hotel__name">Hotel Aishwarya</div>
              <div class="jg-hotel__meta">
                <span class="jg-hotel__stars">★★★★</span>
          ...
          <div class="jg-hotel">
            <img src="{{ asset('images/ajantaheritage.png') }}" alt="Hotel Jay International" class="jg-hotel__img"
                 onerror="this.outerHTML='<div class=\'jg-hotel__img-ph\'>🏨</div>'"/>
            <div class="jg-hotel__body">
              <div class="jg-hotel__name">Hotel Jay International</div>
              <div class="jg-hotel__meta">
                <span class="jg-hotel__stars">★★★★</span>
          ...
          <div class="jg-hotel">
            <img src="{{ asset('images/royalepalace.png') }}" alt="Hotel New Welcome" class="jg-hotel__img"
                 onerror="this.outerHTML='<div class=\'jg-hotel__img-ph\'>🏨</div>'"/>
            <div class="jg-hotel__body">
              <div class="jg-hotel__name">Hotel New Welcome</div>
              <div class="jg-hotel__meta">
                <span class="jg-hotel__stars">★★★</span>
          ...
          <div class="jg-hotel">
            <img src="{{ asset('images/citycomfort.png') }}" alt="Hotel Royal Residency" class="jg-hotel__img"
                 onerror="this.outerHTML='<div class=\'jg-hotel__img-ph\'>🏨</div>'"/>
            <div class="jg-hotel__body">
              <div class="jg-hotel__name">Hotel Royal Residency</div>
              <div class="jg-hotel__meta">
                <span class="jg-hotel__stars">★★★</span>
          ...
          <div class="jg-hotel">
            <img src="{{ asset('images/riversidelodge.png') }}" alt="Hotel Sai Executive" class="jg-hotel__img"
                 onerror="this.outerHTML='<div class=\'jg-hotel__img-ph\'>🏨</div>'"/>
            <div class="jg-hotel__body">
              <div class="jg-hotel__name">Hotel Sai Executive</div>
              <div class="jg-hotel__meta">
                <span class="jg-hotel__stars">★★★★</span>
          ...
          <div class="jg-hotel">
            <img src="{{ asset('images/vrindavan.png') }}" alt="Hotel Radhika Palace" class="jg-hotel__img"
                 onerror="this.outerHTML='<div class=\'jg-hotel__img-ph\'>🏨</div>'"/>
            <div class="jg-hotel__body">
              <div class="jg-hotel__name">Hotel Radhika Palace</div>
              <div class="jg-hotel__meta">
                <span class="jg-hotel__stars">★★★</span>
          ...
          <div class="jg-hotel">
            <img src="{{ asset('images/shivamgrand.png') }}" alt="Hotel Parbhani Pride" class="jg-hotel__img"
                 onerror="this.outerHTML='<div class=\'jg-hotel__img-ph\'>🏨</div>'"/>
            <div class="jg-hotel__body">
              <div class="jg-hotel__name">Hotel Parbhani Pride</div>
              <div class="jg-hotel__meta">
                <span class="jg-hotel__stars">★★★★★</span>
    ...
    <div class="jg-content">
      ...
      <div class="jg-scroll-wrap">
        <div class="jg-hstrip" id="strip-food">
          ...
          <div class="jg-food">
            <img src="{{ asset('images/puranpoli.png') }}" alt="Puran Poli" class="jg-food__img"
          ...
          <div class="jg-food">
            <img src="{{ asset('images/bharlivangi.png') }}" alt="Pithla Bhakri" class="jg-food__img"
                 onerror="this.outerHTML='<div class=\'jg-food__img-ph\'>🍆</div>'"/>
            <div class="jg-food__body">
              <div class="jg-food__name">Pithla Bhakri</div>
              <div class="jg-food__desc">Stuffed baby brinjal</div>
            </div>
          </div>

          <div class="jg-food">
            <img src="{{ asset('images/pohe.png') }}" alt="Bhakri Thecha" class="jg-food__img"
                 onerror="this.outerHTML='<div class=\'jg-food__img-ph\'>🥣</div>'"/>
            <div class="jg-food__body">
              <div class="jg-food__name">Bhakri Thecha</div>
              <div class="jg-food__desc">Spiced flattened rice</div>
            </div>
          </div>

          <div class="jg-food">
            <img src="{{ asset('images/varanbatti.png') }}" alt="Zunka Bhakar" class="jg-food__img"
                 onerror="this.outerHTML='<div class=\'jg-food__img-ph\'>🍌</div>'"/>
            <div class="jg-food__body">
              <div class="jg-food__name">Zunka Bhakar</div>
              <div class="jg-food__desc">Local's Favorite</div>
            </div>
          </div>

          <div class="jg-food">
            <img src="{{ asset('images/misal.png') }}" alt="Misal Pav" class="jg-food__img"
          ...
          <div class="jg-food">
            <img src="{{ asset('images/shevbhaji.png') }}" alt="Kande Pohe" class="jg-food__img"
                 onerror="this.outerHTML='<div class=\'jg-food__img-ph\'>🍜</div>'"/>
            <div class="jg-food__body">
      ...
      <div id="map">
        ...
        <div class="jg-map-frame">
          <iframe
            src="https://maps.google.com/maps?q=Parbhani,Maharashtra,India&output=embed"
            allowfullscreen=""
            loading="lazy"
            referrerpolicy="no-referrer-when-downgrade"
            title="Parbhani on Google Maps">
          </iframe>
        </div>
        <a href="https://www.google.com/maps/place/Parbhani,+Maharashtra"
           target="_blank"
...
<footer class="jg-footer">
  Crafted with care for <strong>Parbhani</strong> — The Cultural Heart of Marathwada.
</footer>
