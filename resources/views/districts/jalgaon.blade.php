...
{{-- ══════════ HERO ══════════ --}}
<div class="jg-hero">
  {{-- Replace with your actual asset path, e.g. asset('jalgaon/jalgaon-hero.jpg') --}}
        ...
        <div class="jg-scroll-wrap mt-2">
          <div class="jg-hstrip" id="strip-attract">
            ...
            <div class="jg-attract">
              <img src="{{ asset('jalgaon/ajanta.png') }}" alt="Ajanta Caves" class="jg-attract__img"
            ...
            <div class="jg-attract">
              <img src="{{ asset('jalgaon/giran.png') }}" alt="Giran River" class="jg-attract__img"
            ...
            <div class="jg-attract">
              <img src="{{ asset('jalgaon/muktai.png') }}" alt="Muktainagar Temple" class="jg-attract__img"
                   onerror="this.outerHTML='<div class=\'jg-attract__img-ph\'>🛕</div>'"/>
              <div class="jg-attract__body">
            ...
            <div class="jg-attract">
              <img src="{{ asset('jalgaon/mehrun.png') }}" alt="Mehrun Lake" class="jg-attract__img"
                   onerror="this.outerHTML='<div class=\'jg-attract__img-ph\'>🏞️</div>'"/>
              <div class="jg-attract__body">
            ...
            <div class="jg-attract">
              <img src="{{ asset('jalgaon/manudevi.png') }}" alt="Manudevi Temple" class="jg-attract__img"
                   onerror="this.outerHTML='<div class=\'jg-attract__img-ph\'>🍌</div>'"/>
              <div class="jg-attract__body">
    ...
    <div class="jg-content">
      ...
      <div class="jg-scroll-wrap">
        <div class="jg-hotel-grid">
          ...
          <div class="jg-hotel">
            <img src="{{ asset('jalgaon/plaza.png') }}" alt="Hotel Plaza" class="jg-hotel__img"
          ...
          <div class="jg-hotel">
            <img src="{{ asset('jalgaon/banana.png') }}" alt="Banana Resort" class="jg-hotel__img"
                 onerror="this.outerHTML='<div class=\'jg-hotel__img-ph\'>🏨</div>'"/>
            <div class="jg-hotel__body">
          ...
          <div class="jg-hotel">
            <img src="{{ asset('jalgaon/ajantaheritage.png') }}" alt="Ajanta Heritage Inn" class="jg-hotel__img"
                 onerror="this.outerHTML='<div class=\'jg-hotel__img-ph\'>🏨</div>'"/>
            <div class="jg-hotel__body">
          ...
          <div class="jg-hotel">
            <img src="{{ asset('jalgaon/royalepalace.png') }}" alt="Royale Palace" class="jg-hotel__img"
                 onerror="this.outerHTML='<div class=\'jg-hotel__img-ph\'>🏨</div>'"/>
            <div class="jg-hotel__body">
              <div class="jg-hotel__name">Royale Palace</div>
              <div class="jg-hotel__meta">
                <span class="jg-hotel__stars">★★★</span>
          ...
          <div class="jg-hotel">
            <img src="{{ asset('jalgaon/citycomfort.png') }}" alt="City Comforts" class="jg-hotel__img"
                 onerror="this.outerHTML='<div class=\'jg-hotel__img-ph\'>🏨</div>'"/>
            <div class="jg-hotel__body">
          ...
          <div class="jg-hotel">
            <img src="{{ asset('jalgaon/riversidelodge.png') }}" alt="Riverside Lodge" class="jg-hotel__img"
                 onerror="this.outerHTML='<div class=\'jg-hotel__img-ph\'>🏨</div>'"/>
            <div class="jg-hotel__body">
          ...
          <div class="jg-hotel">
            <img src="{{ asset('jalgaon/vrindavan.png') }}" alt="Vrindavan Inn" class="jg-hotel__img"
                 onerror="this.outerHTML='<div class=\'jg-hotel__img-ph\'>🏨</div>'"/>
            <div class="jg-hotel__body">
              <div class="jg-hotel__name">Vrindavan Inn</div>
              <div class="jg-hotel__meta">
                <span class="jg-hotel__stars">★★★</span>
          ...
          <div class="jg-hotel">
            <img src="{{ asset('jalgaon/shivamgrand.png') }}" alt="Shivam Grand" class="jg-hotel__img"
                 onerror="this.outerHTML='<div class=\'jg-hotel__img-ph\'>🏨</div>'"/>
            <div class="jg-hotel__body">
    ...
    <div class="jg-content">
      ...
      <div class="jg-scroll-wrap">
        <div class="jg-hstrip" id="strip-food">
          ...
          <div class="jg-food">
            <img src="{{ asset('jalgaon/puranpoli.png') }}" alt="Puran Poli" class="jg-food__img"
          ...
          <div class="jg-food">
            <img src="{{ asset('jalgaon/bharlivangi.png') }}" alt="Bharli Vangi" class="jg-food__img"
                 onerror="this.outerHTML='<div class=\'jg-food__img-ph\'>🍆</div>'"/>
            <div class="jg-food__body">
          ...
          <div class="jg-food">
            <img src="{{ asset('jalgaon/pohe.png') }}" alt="Kande Pohe" class="jg-food__img"
                 onerror="this.outerHTML='<div class=\'jg-food__img-ph\'>🥣</div>'"/>
            <div class="jg-food__body">
          ...
          <div class="jg-food">
            <img src="{{ asset('jalgaon/varanbatti.png') }}" alt="Varan Batti" class="jg-food__img"
                 onerror="this.outerHTML='<div class=\'jg-food__img-ph\'>🍌</div>'"/>
            <div class="jg-food__body">
          ...
          <div class="jg-food">
            <img src="{{ asset('jalgaon/misal.png') }}" alt="Misal Pav" class="jg-food__img"
          ...
          <div class="jg-food">
            <img src="{{ asset('jalgaon/shevbhaji.png') }}" alt="Shev Bhaji" class="jg-food__img"
                 onerror="this.outerHTML='<div class=\'jg-food__img-ph\'>🍜</div>'"/>
            <div class="jg-food__body">
