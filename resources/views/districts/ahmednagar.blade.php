...
<head>
  ...
  <title>Ahilyanagar — Golden City of Maharashtra</title>
...
{{-- ══════════ NAVBAR ══════════ --}}
<nav class="jg-nav">
  <a href="#" class="jg-brand">Ahilyanagar<em>.</em></a>
...
{{-- ══════════ HERO ══════════ --}}
<div class="jg-hero">
  {{-- Replace with your actual asset path, e.g. asset('images/ahilyanagar-hero.jpg') --}}
  <img src="{{ asset('img/Ahilyanagar.png') }}"
       alt="Ahilyanagar aerial night view"
       class="jg-hero__img"
  ...
  <div class="jg-hero__content">
    ...
    <h1 class="jg-hero__title">Ahilyanagar</h1>
    <p class="jg-hero__sub">Historical Heart of Maharashtra</p>
  </div>
</div>
...
<main class="jg-page">
  ...
  <section class="jg-block" id="about">
    ...
    <div class="jg-city-card">
      <img src="{{ asset('images/ahilyanagar.png') }}"
           alt="Ahilyanagar"
           class="jg-city-card__img"
           onerror="this.outerHTML='<div class=\'jg-city-card__img-ph\'>🏙️</div>'"/>
      <div class="jg-city-card__body">
        <div class="jg-city-card__name">Ahilyanagar</div>
        <div class="jg-city-card__desc">Historic forts, Bhandardara landscapes, spiritual destinations and Sahyadri adventures.</div>
      </div>
    ...
    <div class="jg-content">
      <h2 class="jg-heading">About Ahilyanagar</h2>

      <div class="jg-about-box">
    <div class="jg-about-box">
       Ahilyanagar, formerly known as Ahmednagar, is one of Maharashtra's most historically significant cities. Founded in 1490 by Ahmad Nizam Shah, it is renowned for its rich heritage, majestic forts, spiritual landmarks, and breathtaking natural landscapes. The city is home to the historic Ahmednagar Fort, the famous Shani Shingnapur Temple, and serves as a gateway to scenic destinations like Bhandardara and Harishchandragad. Blending history, culture, adventure, and spirituality, Ahilyanagar offers visitors an authentic experience of Maharashtra's diverse heritage.
    </div>
      </div>
        ...
        <div class="jg-scroll-wrap mt-2">
          <div class="jg-hstrip" id="strip-attract">
            ...
            <div class="jg-attract">
              <img src="{{ asset('images/ajanta.png') }}" alt="Ahmednagar Fort" class="jg-attract__img"
              ...
              <div class="jg-attract__body">
                ...
                <div class="jg-attract__name">Ahmednagar Fort</div>
              </div>
            </div>

            <div class="jg-attract">
              <img src="{{ asset('images/giran.png') }}" alt="Bhandardara" class="jg-attract__img"
                   onerror="this.outerHTML='<div class=\'jg-attract__img-ph\'>🌊</div>'"/>
              <div class="jg-attract__body">
                <span class="jg-attract__tag">Nature</span>
                <div class="jg-attract__name">Bhandardara</div>
              </div>
            </div>

            <div class="jg-attract">
              <img src="{{ asset('images/muktai.png') }}" alt="Harishchandragad Fort" class="jg-attract__img"
                   onerror="this.outerHTML='<div class=\'jg-attract__img-ph\'>🛕</div>'"/>
              <div class="jg-attract__body">
                <span class="jg-attract__tag">Spiritual</span>
                <div class="jg-attract__name">Harishchandragad Fort</div>
              </div>
            </div>
    ...
    <div class="jg-content">
      ...
      <div id="map">
        ...
        <div class="jg-map-frame">
          <iframe
            src="https://maps.google.com/maps?q=Ahilyanagar,Maharashtra,India&output=embed"
            allowfullscreen=""
            loading="lazy"
            referrerpolicy="no-referrer-when-downgrade"
            title="Ahilyanagar on Google Maps">
          </iframe>
        </div>
        <a href="https://www.google.com/maps/place/Ahilyanagar,+Maharashtra"
           target="_blank"
...
<footer class="jg-footer">
  Crafted with care for <strong>Ahilyanagar</strong> — Historical Heart of Maharashtra.
</footer>
